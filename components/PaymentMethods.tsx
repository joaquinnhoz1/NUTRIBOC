      ...
      <div className="wrap">
        ...
        <div className="pay-grid">
          <SectionReveal className="pay" delay={0}>
            ...
            <p>Abonás directamente por transferencia y confirmá tu turno enviando el comprobante por WhatsApp.</p>
            <ul>
          ...
          <SectionReveal className="pay" delay={70}>
            ...
            <h3>Mercado Pago</h3>
            <p>Para quienes prefieran pagar con tarjeta de débito, crédito o billeteras virtuales, en un entorno seguro.</p>
            <ul>
              <li><CheckIcon /> Débito y crédito</li>
